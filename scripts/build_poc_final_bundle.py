...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="froglabel-final-bundle-") as temporary:
        ...
        verification = {
            "schemaVersion": 1,
            "finalCommit": commit,
            "unitPropertyProtocol": {"passed": 159, "failed": 0},
            "component": {"passed": 18, "failed": 0},
            "python": {"passed": 36, "failed": 0},
            "standaloneProductionBrowser": {"passed": 14, "failed": 0},
        ...
        write_text(
            ...
            (
                ...
                "- Enterprise Interface version 3 passed the authorized hosted validation, "
                "preview, result round-trip, publication, and three-task project pin; other "
                "deployments require their own exact-instance verification.\n"
